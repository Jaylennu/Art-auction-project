...
| 역할 | 구현 내용 | 담당자 |
|--------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|
| 카카오API구현(배송주문)    | 주소입력 API를 통해 사용자가 익숙하고 친밀한 UI에서 쉽게 배송지 주소를 선택할 수 있고,<br> 선택된 배송지 주소를 데이터에 담아 사용자가 재확인할 수 있게 구현함.  | 유정인  | 
| 카카오페이API구현(결제)   | 카카오페이의 QR코드를 이용한 보다 쉬운 결제서비스를 구현. 카카오페이의 Test카드로 결제가능하도록 구현.  | 유정인 | 
| 작품등록 구현 | 이미지파일을 포함하여 사용자가 입력하는 모든 데이터를 취합하여 Backend 데이터에 전송하도록 구현.  | 유정인  | 
| 자격등록 구현 | 사용자가 데이터 수정을 시각적으로 표현하기 위해 구현. | 유정인  | 
